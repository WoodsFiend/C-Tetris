...
#ifndef GRIDTETRAMINO_H
#define GRIDTETRAMINO_H

#include "Tetramino.h"

class GridTetramino : public Tetramino
{	
public:
	GridTetramino();				// constructor, initialize gridLoc to 0,0
	...
	void setGridLoc(Point pt);		// sets the tetromino's grid/gameboard loc using a Point
